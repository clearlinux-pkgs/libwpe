...
Source0  : https://github.com/WebPlatformForEmbedded/libwpe/releases/download/1.16.0/libwpe-1.16.0.tar.xz
Source1  : https://github.com/WebPlatformForEmbedded/libwpe/releases/download/1.16.0/libwpe-1.16.0.tar.xz.asc
...
%prep
%setup -q -n libwpe-1.16.0
cd %{_builddir}/libwpe-1.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711238119
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwpe-1.0.so.1.9.3
/usr/lib64/libwpe-1.0.so.1
/usr/lib64/libwpe-1.0.so.1.9.3
