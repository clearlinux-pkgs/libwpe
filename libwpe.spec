...
Source0  : https://github.com/WebPlatformForEmbedded/libwpe/releases/download/1.16.2/libwpe-1.16.2.tar.xz
Source1  : https://github.com/WebPlatformForEmbedded/libwpe/releases/download/1.16.2/libwpe-1.16.2.tar.xz.asc
...
%setup -q -n libwpe-1.16.2
cd %{_builddir}/libwpe-1.16.2
pushd ..
cp -a libwpe-1.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738941720
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwpe-1.0.so.1.9.5
/usr/lib64/libwpe-1.0.so.1
/usr/lib64/libwpe-1.0.so.1.9.5
